from vammas166 import reports as vammas166
from delorean1984 import reports as delorean1984
from a1 import reports as a1
from all_reports_all_data import all_reports
import datetime


# NOTE - the following provided code will only consider the duration when the "is_serviceable" value is False. It will not include the duration when "is_serviceable" is None.
...
# <---- START LOGIC ---->
# reports = vammas166["dtreports"]
# reports = delorean1984["dtreports"]
reports = a1["dtreports"]
